...
export class InvalidApiKeyError extends Error { provider: string;
...
export class ProviderRateLimitError extends Error { provider: string;
  constructor(provider) {
...
export class ProviderUnavailableError extends Error { provider: string;
  constructor(provider) {
